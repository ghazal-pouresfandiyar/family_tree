...
<style>
  * {{ margin: 0; padding: 0; box-sizing: border-box; }}
  ...
  .print-btn {{ display: inline-block; margin-top: 8px; padding: 6px 16px; background: #c3a578; color: #fff; border: none; border-radius: 6px; font-size: 12px; cursor: pointer; font-family: inherit; }}
  .print-btn:hover {{ background: #a08060; }}

  @media print {{
    .hero {{ padding: 20px; break-after: avoid; }}
    .print-btn {{ display: none; }}
    .scroll-hint {{ display: none; }}
    .branch-section {{ break-inside: avoid; opacity: 1 !important; transform: none !important; }}
    .siblings-scroll {{ overflow: visible !important; }}
    .siblings-row {{ flex-wrap: wrap !important; }}
    .kids-scroll {{ overflow: visible !important; }}
    .kids-row {{ flex-wrap: wrap !important; }}
    body {{ background: #fff; }}
  }}
